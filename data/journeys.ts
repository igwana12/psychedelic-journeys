...
export const journeysData: Record<string, JourneyData> = {
  ...
  "escape-the-system": {
    name: "Part II: Escape the System",
    slug: "escape-the-system",
    location: "Worldwide",
    coordinates: { lat: 0, lng: 0 },
    type: "Lifestyle Design",
    heroImage: "/images/journeys/escape-the-system/hero.jpg",
    stats: {
      duration: "Ongoing",
      season: "Any time",
      intensity: "Life-changing",
      cost: "Varies (often less than staying)",
    },
    introduction:
      "Not a destination, but a decision. The realization that the script you were handed - college, career, mortgage, retirement - is optional. This is the journey of those who choose to live by their own design, wherever that leads.",
    story: [
      {
        title: "The Awakening",
        content:
          "Maybe it hits during a corporate meeting that could have been an email. Maybe it's watching the sunrise from your desk after another 70-hour week. Maybe it's turning 30, 40, 50 and realizing you've been living someone else's dream. The moment of awakening is different for everyone, but the feeling is the same: there has to be another way. You start doing the math. Your apartment costs $2000/month. You could live in Chiang Mai, Lisbon, or Medellín for $800 and have a better quality of life. Your car payment could fund travel for months. The retirement you're saving for could be lived now in places where cost of living is 60% lower. The prison door was never locked. You just had to push.",
      },
      {
        title: "Taking the Leap",
        content:
          "The hardest part isn't the logistics - it's telling your family you're quitting the 'good job' to travel and work remotely. It's watching friends' faces when you say you're selling everything and buying a one-way ticket. The judgment is heavy. But so is dying with your dreams still inside you. You give notice. You sell, donate, or store your stuff. You realize 90% of what you owned was weighing you down. You book the flight. The night before departure, you're terrified and exhilarated in equal measure. You're not running away from your life. You're finally running toward it.",
      },
      {
        title: "The Digital Nomad Reality",
        content:
          "The Instagram version is laptop on beach, cocktail at sunset, endless freedom. The reality is more complex and more real. Yes, you work from a cafe in Vietnam where your coffee costs $1. Yes, you take midweek trips to temples and beaches. But you also work. You hustle to find clients, build your freelance business, or maintain your remote job. Some days the wifi crashes before an important call. Some days you're lonely, untethered, questioning everything. But then you remember: last year at this time, you were in a cubicle having the same day on repeat. Now every day is different. The uncertainty is the point. You're finally alive.",
      },
      {
        title: "Finding Your Tribe",
        content:
          "The location-independent lifestyle isn't lonely once you find your people. They're in coworking spaces in Bali, hostels in Colombia, meetups in Portugal. They're ex-lawyers now teaching English online. They're developers who code from sailboats. They're writers, designers, consultants, and entrepreneurs who said 'no thanks' to the default path. You find that your best friendships form quickly when people are this intentional about their lives. There's no small talk about traffic or weather. Conversations dive deep immediately: Why did you leave? What are you building? What matters to you? You realize - this is your tribe. Not defined by where you're from, but by how you choose to live.",
      },
    ],
    microRituals: [
      {
        ...
        description:
          "Once a month, audit your spending and income. Are you making this lifestyle sustainable? Where can you optimize? Awareness is freedom.",
      },
      {
        title: "3-Month Location Shifts",
        description:
          "Don't just hop from place to place. Spend at least 3 months somewhere to really experience it. Slow travel beats tourist racing.",
      },
      {
        title: "Weekly Skill Building",
        description:
          "Dedicate time each week to learning something that increases your value - coding, writing, marketing, languages. Your skills are your security.",
      },
      {
        title: "Community Check-ins",
        description:
          "Make effort to connect with other nomads and locals. Join coworking spaces, attend meetups, say yes to invitations. Community is everything on the road.",
      },
    ],
    gallery: [
      "/images/journeys/escape-the-system/gallery/1.jpg",
      "/images/journeys/escape-the-system/gallery/2.jpg",
      "/images/journeys/escape-the-system/gallery/3.jpg",
      "/images/journeys/escape-the-system/gallery/4.jpg",
      "/images/journeys/escape-the-system/gallery/5.jpg",
      "/images/journeys/escape-the-system/gallery/6.jpg",
    ],
    tips: [
      "Start with remote work or freelance clients before quitting - have income secured",
      "Test the lifestyle with a 3-month sabbatical before burning all bridges",
      "Southeast Asia (Thailand, Vietnam, Indonesia) is cheapest to start. Portugal, Mexico, Colombia offer better infrastructure",
      "Get good international health insurance - safety net is important",
      "Use tools: Nomad List for cost research, Workaway for trading work for accommodation, Couch Surfing for free stays",
      "Build multiple income streams - don't rely on one client or job",
      "Learn basic tax law for digital nomads - you can save significantly",
      "Stay somewhere long enough to get local prices and rhythms - tourist areas are expensive",
      "Not everyone will understand your choice - that's okay. Find your tribe online first.",
      "This lifestyle is a tool for freedom, not an escape from problems. Your issues travel with you.",
      "Some people do this for 6 months and return. Some for years. Some forever. All versions are valid.",
      "The point isn't to reject stability forever - it's to choose consciously rather than by default",
    ],
  },
};
